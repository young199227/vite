...
<template>
  ...
  <el-affix :offset="0">
    ...
    <el-menu class="el-menu-demo" mode="horizontal" :ellipsis="false">
      ...
      <el-sub-menu index="2">
        ...
        <el-menu-item index="2-1" @click="listSelectClick('mag')">
          <img style="width: 30px" src="/img/黑魔島士.png" alt="Element logo" />
          　黑魔導士
        </el-menu-item>
        <el-menu-item index="2-2" @click="listSelectClick('bow')">
          <img style="width: 30px" src="/img/狙擊手.png" alt="Element logo" />
          　狙擊手
        </el-menu-item>
      </el-sub-menu>
    ...
    <!-- 新增技能表單 -->
    <el-dialog v-model="skillFormVisible" title="新增技能" class="w-90">
